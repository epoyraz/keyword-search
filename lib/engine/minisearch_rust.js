/* @ts-self-types="./minisearch_rust.d.ts" */

export class MiniSearchWasm {
    static __wrap(ptr) {
        const obj = Object.create(MiniSearchWasm.prototype);
        obj.__wbg_ptr = ptr;
        MiniSearchWasmFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MiniSearchWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_minisearchwasm_free(ptr, 0);
    }
    /**
     * @param {any} document
     */
    add(document) {
        const ret = wasm.minisearchwasm_add(this.__wbg_ptr, document);
        if (ret[1]) {
     ...
     */
    addAll(documents) {
        const ret = wasm.minisearchwasm_addAll(this.__wbg_ptr, documents);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    addAllJSON(documents) {
        const ptr0 = passStringToWasm0(documents, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.minisearchwasm_addAllJSON(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    discard(id) {
        const ret = wasm.minisearchwasm_discard(this.__wbg_ptr, id);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @returns {MiniSearchWasm}
     */
    static loadBytes(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.minisearchwasm_loadBytes(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return MiniSearchWasm.__wrap(ret[0]);
    }
    /**
    ...
    static loadJSON(serialized) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.minisearchwasm_loadJSON(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return MiniSearchWasm.__wrap(ret[0]);
     ...
     */
    constructor(options) {
        const ret = wasm.minisearchwasm_new(options);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        MiniSearchWasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {any} document
     */
    remove(document) {
        const ret = wasm.minisearchwasm_remove(this.__wbg_ptr, document);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    search(query, options) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.minisearchwasm_search(this.__wbg_ptr, ptr0, len0, options);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     * @param {string} query
     * @param {boolean} or_mode
     * @returns {number}
     */
    searchCountDefault(query, or_mode) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.minisearchwasm_searchCountDefault(this.__wbg_ptr, ptr0, len0, or_mode);
        return ret;
    }
    /**
     ...
     * @returns {number}
     */
    searchCountOpts(query, prefix, fuzzy) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.minisearchwasm_searchCountOpts(this.__wbg_ptr, ptr0, len0, prefix, fuzzy);
        return ret;
    }
    /**
     ...
     * @returns {any}
     */
    searchJoined(query, or_mode) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.minisearchwasm_searchJoined(this.__wbg_ptr, ptr0, len0, or_mode);
        return ret;
    }
    /**
     * @returns {Uint8Array}
     */
    toBytes() {
        const ret = wasm.minisearchwasm_toBytes(this.__wbg_ptr);
        if (ret[3]) {
     ...
     */
    toJSON() {
        const ret = wasm.minisearchwasm_toJSON(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    toJSONString() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.minisearchwasm_toJSONString(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
if (Symbol.dispose) MiniSearchWasm.prototype[Symbol.dispose] = MiniSearchWasm.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_length_750ab89c52b42479: function(arg0) {
            const ret = arg0.length;
            return ret;
        },
        ...
        __wbg_set_404b02690d27a687: function(arg0, arg1, arg2) {
    ...
    return {
        __proto__: null,
        "./minisearch_rust_bg.js": import0,
    };
}

const MiniSearchWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_minisearchwasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('minisearch_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
